...
import GitOpsLMS from './GitOpsLMS';
import GitOpsSimulator from './GitOpsSimulator';
import V11AccountMgmt from './versions/V11AccountMgmt.jsx';
import Lecture3Preview from './Lecture3Preview.jsx';
...
const lectureData = [
  ...
  {
    id: 3,
    title: "Lecture 3: Coming Soon",
    color: "#20c997",
    headerColor: "#138c6e",
    links: [
      { to: "/lecture3/preview", label: "Preview Content", featured: true }
    ]
  }
];
